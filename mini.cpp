...
public:
    ...
    int j_detail() 
    {
        ...
        cin >> doj;
        cout << "1.Sendhwa(1) \t2.Chhindwara(2) \t3.Valsad(3) \t4.Shirpur(4)" << endl << endl;
        ...
        if((src==1 && dest==2) || (src==2 && dest==1))
        {
            ...
            cout << "3.Kingfisher(3)\t19:00\t\t22:05\t\tRs.6000\t\tRefundable\n";
        }
        ...
        else if((src==1 && dest==4) || (src==4 && dest==1))
        {
            ...
            cout << "3.Kingfisher(3)\t19:00\t\t22:05\t\tRs.6100\t\tRefundable\n";
        }
        ...
        else if((src==2 && dest==3) || (src==3 && dest==2))
        {
            ...
            cout << "3.Kingfisher(3)\t19:00\t\t22:05\t\tRs.2890\t\tRefundable\n";
        }
        ...
        else if((src==2 && dest==4) || (src==4 && dest==2))
        {
        ...
        else if((src==3 && dest==4) || (src==4 && dest==3))
         {
            ...
            cout << "3.Kingfisher(3)\t19:00\t\t22:05\t\tRs.6050\t\tRefundable\n";
        }
        else if(src==dest)
        {
...
public:
    ...
    int j_detaili()
    {
        ...
        if((srci==1 && desti==3) || (srci==3 && desti==1))
        {
            ...
            cout << "2.Indigo(2)\t14:00\t\t18:05\t\tRs.21500\tRefundable\n";
            cout << "3.Air India(3)\t18:00\t\t22:05\t\tRs.24000\tRefundable\n";
        }
        ...
        else if((srci==1 && desti==4) || (srci==4 && desti==1))
        {
            ...
            cout << "2.Indigo(2)\t14:00\t\t18:05\t\tRs.21300\tRefundable\n";
            cout << "3.Air India(3)\t18:00\t\t22:05\t\tRs.24650\t\tRefundable\n";
        }
        ...
        else if((srci==1 && desti==5) || (srci==5 || desti==1))
        {
            ...
            cout << "2.Indigo(2)\t14:00\t\t18:05\t\tRs.59420\tRefundable\n";
            cout << "3.Air India(3)\t18:00\t\t22:05\t\tRs.64892\tRefundable\n";
        }
        ...
        else if((srci==2 && desti==3) || (srci==3 && desti==2))
        {
            ...
            cout << "2.Indigo(2)\t14:00\t\t18:05\t\tRs.14900\tRefundable\n";
            cout << "3.Air India(3)\t18:00\t\t22:05\t\tRs.18700\tRefundable\n";
        }
        ...
        else if((srci==2 && desti==4) || (srci==4 && desti==2))
        {
            ...
            cout << "2.Indigo(2)\t14:00\t\t18:05\t\tRs.38500\tRefundable\n";
            cout << "3.Air India(3)\t18:00\t\t22:05\t\tRs41259\tRefundable\n";        }

        else if(srci==2 && desti==5 || (srci==5 && desti==2))
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "1.Vistara(1)\t10:00\t\t14:05\t\tRs.82500\tRefundable\n";
            cout << "2.Indigo(2)\t14:00\t\t18:05\t\tRs.87550\tRefundable\n";
            cout << "3.Air India(3)\t18:00\t\t22:05\t\tRs81478\tRefundable\n";
...
public:
    ...
    {     cout << "\n\n\nHow would you like to pay?:\n";
        ...
        case 2:
            ...
            break;
        case 3:
            cout << "Banks Available: 1.Punjab National(1) 2.SBI(2) 3.HDFC(3) 4.ICICI(4) 5.Others(5)";
            cout << "\nSelect your bank:";
            cin >> bank;
